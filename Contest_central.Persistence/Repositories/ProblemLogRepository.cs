...
public class ProblemLogRepository : GenericRepository<ProblemLog>, IProblemLogRepository
{
    private readonly ContestCentralAppDbContext _context;
    public ProblemLogRepository(ContestCentralAppDbContext contestCentralAppDbContext) : base(contestCentralAppDbContext)
    {
